  ...
  <view>
		...
		<view class="bg-white indexbg flex" :style="{backgroundImage: `url(${imageurl + '/bg.png'})`}">
		  ...
		  <view class="cu-bar bg-white margin-top hexin">
				...
				<image class="hexin_more" :src="imageurl + '/gengduo.png'"></image>
		  </view>
		  <view class="cu-bar bg-white">
			  <view class="cu-list grid col-3" style="width: 100%;">
				  <view class="cu-item">
					  <view>
						  <view class="text-red">34.33%</view>
						  <view>班级满班率</view>
					  </view>
				  </view>
				  <view class="cu-item">
						  <view class="text-cyan">34.33%</view>
						  <view>学员退费率</view>
				  </view>
				  <view class="cu-item">
						  <view class="text-orange">34.33%</view>
						  <view>续签金额比</view>
				  </view>
			  </view>
		  </view>
		  ...
		  <view class="cu-bar bg-white keshi">
				<view class="flex p-xs margin-bottom-sm mb-sm border" style="width: 100%;">
					  <view class="flex-treble padding-sm margin-xs radius text-red">0.00课时</view>
...
<script>
import Footer from '../../common/principal_footer/footer.vue'
export default {
  data() {
	return {
		imageurl:'',
