...
export default{
  /*学生详情*/
  info(data){
    return axios({ url: '/student/info', method: "post", data})
  },
  //查询跟进记录列表
  followup(data){
    return axios({ url: '/student/followup', method: "post", data})
  },
  //添加跟进记录
  addfollowup(data){
    return axios({ url: '/student/addfollowup', method: "post", data})
  },
  /**
   * @param {Object} opt
   ...
   */
  sourcelist(data){
    return axios({ url: '/student/sourcelist', method: "post", data})
  },
  /**
   * @param {Object} opt
   ...
   */
  growthlist(data){
    return axios({ url: '/student/growthlist', method: "post", data})
  },
  growthinfo(opt){
    return axios({ url: '/student/growthinfo', method: "post", data})
  },
  /**
   * @param {Object} opt
   * id : int (添加默认传0)
   ...
   */
  operatorgrowth(data){
    return axios({ url: '/student/operatorgrowth', method: "post", data})
  },
  //成长记录模板详情
  growthtemplateinfo(data){
    return axios({ url: '/student/growthtemplateinfo', method: "post", data})
  },
  //学员档案
  /**
   * @param {Object} opt
  ...
  operatorstudent(data){
    return axios({ url: '/student/operatorstudent', method: "post", data})
  },
  //批量添加跟进人
  addfollowstaff(data){
    return axios({ url: '/student/addfollowstaff', method: "post", data})
  }
